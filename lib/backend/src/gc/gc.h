...
class CustomGCMetadataPrinter : public llvm::GCMetadataPrinter {
public:
...
static llvm::GCMetadataPrinterRegistry::Add<CustomGCMetadataPrinter>
    Y("custom-gc", "Custom GC Metadata Printer");

// Обновляем класс CustomGCStrategy
class CustomGCStrategy : public llvm::GCStrategy {
public:
    CustomGCStrategy() {
        UsesMetadata = true;
...
static llvm::GCRegistry::Add<CustomGCStrategy>
    X("custom-gc", "Custom garbage collector implementation");
