...
public:
  ...
  enum {
    ...
    RuleForBlock = 5, RuleFunctionBlock = 6, RuleParameterList = 7, RuleParameter = 8, 
    RuleReturnType = 9, RuleBlock = 10, RuleVariableDeclaration = 11, RuleVariableDefinition = 12, 
    RuleFunctionCall = 13, RuleArgumentList = 14, RuleExpression = 15, RuleAssignmentOp = 16, 
    RuleMultOp = 17, RuleAddOp = 18, RuleCompareOp = 19, RuleBoolOp = 20, 
    RuleType = 21, RuleConstant = 22
  };
